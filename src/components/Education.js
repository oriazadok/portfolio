      ...
      <div className="container">
        ...
        <div className="education-details">
          <div className="education-item">
            ...
            <p>Ariel University, 2020 - 2024</p>
            <ul className="vertical">
              <li>Deep understanding of programming fundamentals including Design Patterns, OOP, Data Structures, Testing, Debugging and Computer Architecture.</li>
